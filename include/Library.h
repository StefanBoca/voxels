...
extern "C" Voxels::InitError InitializeVoxels(int version, Voxels::LogMessage logger, Voxels::VoxelsAllocators* allocators);

/// Deinitializes the library
///
extern "C" void DeinitializeVoxels();

/// Returns the build version of the library
///
extern "C" unsigned GetBuildVersion();
